...
//
//class FPTabBarController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
//
//  //var centerButton: MDCFloatingButton!
//  var alert = UIAlertController(title: nil, message: nil, preferredStyle: .actionSheet)
//  var feedViewController: FPFeedViewController? {
//   // return viewControllers?[0] as? FPFeedViewController
//    return nil
//  }
//
//
...
//
//
////    centerButton = MDCFloatingButton(frame: CGRect(x: 0, y: 0, width: 56, height: 56))
